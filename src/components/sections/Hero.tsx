        ...
        <div className="relative max-w-6xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <button className="group  bg-gradient-to-r from-blue-500 to-sky-500  hover:bg-blue-700 px-10 py-5 rounded-2xl font-bold text-xl transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/25 flex items-center gap-3">
              <a href="https://docs.ton.org/v3/documentation/smart-contracts/tolk/overview" target="_blank" className="flex flex-row items-center gap-3">
                <FileText size={26} />
                Documentation
                <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
              </a>
            </button>
            <button className="group border-2 bg-white border-gray-800 hover:border-sky-500 px-10 py-5 rounded-2xl font-bold text-xl transition-all duration-300 hover:bg-cyan-400/20 flex items-center gap-3">
            <a href="https://github.com/ton-blockchain/ton/tree/master/tolk" target="_blank" className="flex flex-row items-center gap-3">
              <Github size={27} />
